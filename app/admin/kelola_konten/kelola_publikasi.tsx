            ...
            <div className="px-4 sm:px-6 py-4">
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Kelola Publikasi</h2>
                </div>
            ...
            <div className="border-4 border-dashed border-gray-200 rounded-lg min-h-96 flex items-center justify-center">
              <div className="text-center px-4">
                ...
                <p className="text-gray-500 text-sm sm:text-base max-w-md mx-auto">
                  Ini adalah halaman untuk mengelola publikasi. Fitur akan ditambahkan di sini.
                </p>
              </div>
            </div>
          </div>
