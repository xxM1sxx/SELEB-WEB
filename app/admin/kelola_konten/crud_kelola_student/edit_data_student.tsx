...
export const meta: MetaFunction = () => {
  return [
    ...
    { name: "description", content: "Edit Student - Admin" },
  ];
};
...
export default function EditDataStudent() {
      ...
      try {
        ...
        if (data) {
          setFormData({
            ...
            research_link: data.link_penelitian || ""
          });
        ...
        navigate("/admin/kelola_konten/kelola_student");
      } finally {
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .update({
          ...
          link_penelitian: formData.research_link,
          image: imageUrl
        })
        .eq('id', id);
      ...
      alert("Gagal memperbarui data student. Silakan coba lagi.");
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <ProtectedRoute>
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Memuat data student...</p>
          </div>
        </div>
      </ProtectedRoute>
    );
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-6">
                    ...
                    {/* Research Link */}
                    <div>
                      <label htmlFor="research_link" className="block text-sm font-medium text-gray-700 mb-2">
                        Link Penelitian
                      </label>
                      <input
                        type="url"
                  ...
                  {/* Research Topic */}
                  <div>
                    <label htmlFor="research_topic" className="block text-sm font-medium text-gray-700 mb-2">
                      Topik Penelitian *
                    </label>
                    <textarea
                      id="research_topic"
                  ...
                  <div className="flex justify-end space-x-4 pt-6">
                    <button
                      type="button"
                      onClick={() => navigate("/admin/kelola_konten/kelola_student")}
