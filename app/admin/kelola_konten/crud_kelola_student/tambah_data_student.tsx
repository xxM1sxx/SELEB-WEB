...
export default function TambahDataStudent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (selectedImage && !imageUrl) {
        alert("Data student berhasil ditambahkan (tanpa gambar)!");
      } else {
        alert("Data student berhasil ditambahkan!");
      }
      navigate("/admin/kelola_konten/kelola_student");
    } catch (error) {
      console.error("Error adding student:", error);
      if (error instanceof Error) {
        alert(`Gagal menambahkan data student: ${error.message}`);
      } else {
        alert("Gagal menambahkan data student. Silakan coba lagi.");
      }
    } finally {
      setIsLoading(false);
    }
            ...
            <div className="px-4 sm:px-6 py-4">
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Tambah Student</h2>
                </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-white rounded-lg shadow-md p-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {/* Topik Riset */}
                  <div>
                    <label htmlFor="topik_riset" className="block text-sm font-medium text-gray-700 mb-2">
                      Topik Riset *
                    </label>
                    <textarea
                      id="topik_riset"
